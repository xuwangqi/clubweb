...
public class User implements Serializable {
	...
	public String toString() {
		return "User [userUid=" + userUid + ", userId=" + userId + ", userPassword=" + userPassword + ", userName="
				+ userName + ", userGender=" + userGender + ", userClass=" + userClass + ", userEmail=" + userEmail
				+ ", userQQ=" + userQQ + ", userPhone=" + userPhone + ", userPhonemin=" + userPhonemin + ", userGrade="
