	...
	<div class="container theme-showcase" role="main">
      ...
      <div class="col-center-block">
			<ul class="pager">
				...
				<li><a href="/club/act/query/myact/${club.clubUid}?type=${type}&page=${page.currentPage-1}">&laquo;</a></li>
				<li><a href="/club/act/query/myact/${club.clubUid}?type=${type}&page=1">1</a></li>
				<li><a href="#">...</a></li>
				</c:if>
				<li><a href="#">${page.currentPage}</a></li>			
				<c:if test="${page.totalPage>page.currentPage}">
				<li><a href="#">...</a></li>
				<li><a href="/club/act/query/myact/${club.clubUid}?type=${type}&page=${page.totalPage}">${page.totalPage}</a></li>
				<li><a href="/club/act/query/myact/${club.clubUid}?type=${type}&page=${page.currentPage+1}">&raquo;</a></li>
				</c:if>
			</ul>
		</div>
